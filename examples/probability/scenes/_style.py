...
SYNCED SNAPSHOT of the canonical /scenes/_style.py (the previous "frozen"
copy drifted until the reference scene no longer imported: it named helpers
the snapshot never received). Apply fixes to /scenes/_style.py and re-copy it
here; do not edit this file directly.
